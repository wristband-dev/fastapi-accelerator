        ...
        <div className="space-y-4">
          <div>
            ...
            <button
              ...
              className="w-full px-4 py-6 border border-dashed border-gray-300 dark:border-gray-600 rounded-xl text-sm text-gray-700 dark:text-gray-300 hover:border-primary hover:bg-primary/5 dark:hover:bg-primary/10 transition-colors"
            >
          ...
          {googleUploadMessage && (
            <div className="p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl">
              <div className="flex items-start space-x-3">
                ...
                <p className="text-sm text-green-800 dark:text-green-200">{googleUploadMessage}</p>
              </div>
            </div>
          )}
          ...
          {googleUploadError && (
            <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-xl">
              <div className="flex items-start space-x-3">
                ...
                <p className="text-sm text-yellow-800 dark:text-yellow-200">{googleUploadError}</p>
              </div>
            </div>
          )}
